...
public class NoonAlertReceiver extends BroadcastReceiver {
    private static final String TAG = MorningAlertReceiver.class.getSimpleName();
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        nb = notificationHelper.getChannelNotification(messages.messages[index]);
