...
import com.tyagiabhinav.dialogflowchatlibrary.util.StepCounterEvent;
...
//
//        Intent a = new Intent(chatbotActivity, NotesListActivity.class);
//        startActivity(a);
        ...
        circularGauge.data(new SingleValueDataSet(new String[] { stepPerc, "34", "61", "93", "56", "100"}));
        ...
        bar0.radius(100d);
        bar0.width(17d);
        bar0.fill(new SolidFill("#42f56c", 1d));
        bar0.stroke(null);
        bar0.zIndex(5d);
...
//    public void onMessageEvent(StepCounterEvent event) {
//
//    };
